class App
	...
	Main: ->
		...
		@images = [
			{ src:"images/waiting.gif",      id:"wait" },
			{ src:"images/main.png",         id:"main" },
			{ src:"images/bg.png",           id:"bg" },
			{ src:"images/paddle.png",       id:"player_1" },
			{ src:"images/paddle.png",       id:"player_2" },
			{ src:"images/ball.png",         id:"ball" },
			{ src:"images/player_1_win.png", id:"player_1_win" },
			{ src:"images/player_2_win.png", id:"player_2_win" }
		]
