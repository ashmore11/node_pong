...
(function() {
  var app, ball, express, increase_speed, io, player_1, player_1_score, player_2, player_2_score, port, reset, sockets, start_game, timer, update, user_num, users, x_speed, y_speed;
  ...
  io.sockets.on('connection', (function(_this) {
    return function(socket) {
      socket.on('adduser', function(user) {
        ...
        for (i = _i = 0, _len = sockets.length; _i < _len; i = ++_i) {
          id = sockets[i];
  ...
  update = function() {
    ...
    if (ball.x < 1) {
      ...
      return io.sockets.emit('player_2_score', player_1_score, player_2_score);
    }
  };
